...
export default function Home() {
  ...
  const conversation = useConversation({
    ...
    onMessage: (message) => {
      ...
      const messageText = typeof message === "object" && message && "message" in message ? String(message.message) : JSON.stringify(message);
    ...
    <>
      <header className="topbar">
        <div className="topbar-inner">
          ...
          <a className="topbar-github" href="https://github.com/kytona/elevenlabs-knowledge-agent" target="_blank" rel="noopener noreferrer">
            GitHub &rarr;
          </a>
        </div>
      </header>
      ...
      <main className="hero">
        <div className="hero-grid">
          <div className="hero-left">
            ...
            <p className="subtitle">Route each turn through your FastAPI webhook for retrieval, prompt augmentation, and model routing before streaming TTS.</p>
            <div className="stack">
          ...
          <div className="console">
            <div className="console-header">
              ...
              <div className="console-actions">
                <button type="button" className="btn-start" disabled={statusText === "connected" || statusText === "connecting"} onClick={startConversation}>
                  Start
                </button>
                <button type="button" className="btn-stop" disabled={statusText !== "connected"} onClick={endConversation}>
                  Stop
                </button>
              </div>
            </div>
            ...
            <div className="console-transcript" ref={transcriptRef} aria-live="polite">
              {logs.length === 0 ? (
                <div className="transcript-placeholder">Ask about The Adventure of the Speckled Band — try &quot;Who hired Holmes?&quot; or &quot;What was the speckled band?&quot;</div>
              ) : (
        ...
        <div className="architecture-grid">
          ...
          <div className="architecture-copy">
            ...
            <p className="section-body">
              ElevenLabs handles VAD and speech-to-text, then posts an OpenAI-style chat completion request to your Railway-hosted backend. The backend embeds the latest user utterance, retrieves the
              top matching chunks from Qdrant, and injects them into the system prompt before forwarding the request to the configured LLM.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section section--secondary">
        ...
        <ul className="troubleshoot-list">
          <li>
            Set the Custom LLM Server URL in ElevenLabs to your backend URL (e.g. <code>https://your-backend.up.railway.app</code>).
          </li>
          <li>Run the ingestion command before starting the voice client so Qdrant contains the Speckled Band sample story.</li>
          <li>
            Set <code>NEXT_PUBLIC_ELEVENLABS_AGENT_ID</code> in the Railway frontend service or locally for preview.
          </li>
        </ul>
      </section>
      ...
      <footer className="footer">
        ...
        <p className="disclaimer">This project is not affiliated with, endorsed by, or associated with ElevenLabs in any way. It is an independent demo.</p>
      </footer>
    </>
  );
}
